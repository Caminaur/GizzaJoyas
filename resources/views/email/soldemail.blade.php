...
<body class="respond" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
                                ...
                                <tr>
                                    <td align="center" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <div style="line-height: 24px">
                                            ...
                                            El usuario {{Auth::user()->name}} ha realizado una compra, a continuación se muestra el detalle:
                                        </div>
                                    </td>
                                </tr>
                            </table>
  ...
  @endforeach
        ...
        <div style="line-height: 35px">
          ...
          @php
          // traemos el total de la compra desde MP con los intereses
                                ...
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;"
                                        ...
                                        <div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                                            ...
                                            @if (Auth::user()->email == $purchases->email)
                                              Email de {{Auth::user()->name}}: <br/> <a href="mailto:" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">{{Auth::user()->email}}</a>
                                            @else
