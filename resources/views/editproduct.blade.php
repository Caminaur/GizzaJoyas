...
@section('main')
  ...
  <div class="container text-center pb-4">
      ...
      <div class="uk-card uk-card-default uk-card-body uk-margin-small">
        ...
        <form class="p-4" action='/editproduct/{{$product['id']}}' method="post" enctype="multipart/form-data">
          ...
          <div class="m-5"></div> {{-- div separador --}}
            ...
            <div class="row justify-content-center">
              ...
              <button id="editproduct" hidden class="btn border-ashBlue" type="submit">Editar producto</button>
        ...
        <label for="editproduct" class="btn bg-blueSlate my-5" type="submit">Editar producto</label>
