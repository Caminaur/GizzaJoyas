...
<div uk-sticky="sel-target: .uk-navbar-container; cls-active: uk-navbar-sticky; bottom: #transparent-sticky-navbar">
        ...
        {{-- navbar principal --}}
        <nav class="cbp-af-header uk-navbar-container uk-flex uk-flex-middle" uk-navbar>

          {{-- La parte izquierda de la nav --}}
          <div class="uk-navbar-left uk-margin-left">

            {{-- Search desktop, se muestra en resoluciones M o mayores (959px)--}}
            <form class="uk-visible@m uk-search uk-search-default">
              <span uk-search-icon></span>
              <input class="uk-search-input" type="search" placeholder="Search...">
            </form>

            {{-- Items del lado izquierdo de la nav solo son visibles en resoluciones mayores o iguales a M (959px) --}}
            <ul class="cbp-af-header uk-visible@m uk-navbar-nav uk-nav-parent-icon uk-margin-left">
          ...
          {{-- Items del centro de la nav, son siempre visibles --}}
